...
export class DevicesConfigSonoffT12CH extends DevicesConfigBase {
  constructor() {
    super();
  ...
  fromBooleanToStateConverter(value: Boolean, signalName: String):any {
    ...
    console.error(
      "could not determine actual state value, on Devices Config_S20 Socket from Boolean To State Converter"
    );
    return undefined;
  }
